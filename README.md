...
[![GoDoc](https://godoc.org/github.com/braams/gokrb5?status.svg)](https://godoc.org/github.com/braams/gokrb5) [![Go Report Card](https://goreportcard.com/badge/github.com/braams/gokrb5)](https://goreportcard.com/report/github.com/braams/gokrb5) [![Build Status](https://travis-ci.org/jcmturner/gokrb5.svg?branch=master)](https://travis-ci.org/jcmturner/gokrb5)
...
```
go get -d github.com/braams/gokrb5/...
```
To import this package, add the following line to your code:
```go
import "github.com/braams/gokrb5/<sub package>"
```
...
```go
import "github.com/braams/gokrb5/config"
...
```go
import 	"github.com/braams/gokrb5/keytab"
...
```go
import 	"github.com/braams/gokrb5/client"
...
```go
import 	"github.com/braams/gokrb5/service"
